...
if(location.hash==='#inspections'){showScreen('inspections');if(!lists.inspections.initialized)loadCases('inspections',true)}else if(portalModel.focusedCase)openCase(portalModel.focusedCase.sourceRecordId);
`;
